...
pagination:
  visible: true
description: Node.js, JavaScript/Typescript client for Bucket.co
layout:
  title:
    visible: true
  description:
...
To get started you need to obtain your secret key from the [environment settings](https://app.bucket.co/envs/current/settings/app-environments) in Bucket.
...
To get type checked feature flags, add the list of flags to your `bucket.ts` file. Any feature look ups will now be checked against the list you maintain.
