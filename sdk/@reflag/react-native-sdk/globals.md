...
| Name    | Type                                             |
| ------- | ------------------------------------------------ |
| `flags` | [`RawFlags`](../browser-sdk/globals.md#rawflags) |
...
| `logger`?           | [`Logger`](../browser-sdk/globals.md#logger-1) | A custom logger to use for SDK logs. Use this for advanced control or filtering of SDK logs. If both `logger` and `debug` are provided, `logger` takes precedence. |
...
See [link](https://github.com/reflagcom/docs/blob/main/sdk/browser-sdk/FEEDBACK.md#reflagclientrequestfeedback-options) for more information
...
See [link](https://github.com/reflagcom/docs/blob/main/sdk/browser-sdk/FEEDBACK.md#using-your-own-ui-to-collect-feedback) for more information
